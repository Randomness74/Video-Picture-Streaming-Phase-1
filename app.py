...
client = pymongo.MongoClient("mongodb+srv://doadmin:35b68ZJNd1L4n07x@gridcluster-d2319a10.mongo.ondigitalocean.com/GridCluster?authSource=admin&replicaSet=gridcluster?ssl=true&ssl_cert_reqs=CERT_NONE?connect=False"
)
